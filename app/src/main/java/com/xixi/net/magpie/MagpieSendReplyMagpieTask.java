...
public class MagpieSendReplyMagpieTask {
	...
	public MagpieSendReplyMagpieTask(RequestParams params, JSONReceiver receiver) {
		this.params = params;
		this.receiver = receiver;
	}
	
	public void execute() {
		String url = RequestUrl.HOST + "postReplies/repliespost";
